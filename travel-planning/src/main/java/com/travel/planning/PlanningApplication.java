...
import com.travel.webmvc.WebMvcMarker;
 ...
 * 扫描范围与原 {"com.travel.planning","com.travel.common","com.travel.webmvc"}
 * 完全一致（ChatDomainMarker 与 PlanningMarker 同根包，跨 jar 合并语义不变；
 * chat-domain 域配置单源见 classpath:application-chat.yml）。</p>
 *
 * @author david_ency
...
@SpringBootApplication(scanBasePackageClasses = {
        ...
        WebMvcMarker.class})        // travel-web-mvc（SseStreamAdapter/RateLimitInterceptor/全局异常）
